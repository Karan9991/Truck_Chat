...
class _ChatListrState extends State<ChatListr>
          ...
          try {
            ...
            if (response.statusCode == 200) {
              ...
              try {
                ...
                // Check if the conversation is marked as deleted
                // int deletedIndex = storedConversations.indexWhere(
                //   (c) => c.conversationId == serverMessageId && c.isDeleted,
                // );
  ...
  //   List<Conversation> storedConversations = await getStoredConversations();
  //   storedConversations.removeWhere(

...
//                 // _updateListData(serverMessageId, counts, conversationTopic,
...
//     Future<void> updateConversationsData() async {
//     // setState(() {
//     //   isLoading = true;
//     // });
//     String? userId = SharedPrefs.getString(SharedPrefsKeys.USER_ID);
...
// //worked
//   // void _updateListData(String serverMsgId, String counts, String topic) {
//   //   setState(() {
//   //     int index = serverMsgIds.indexOf(serverMsgId);
//   //     if (index != -1) {
//   //       // Update specific list item at the given index
//   //       replyCounts[index] = counts;
//   //       conversationTopics[index] = topic;
//   //       conversationTimestamps[index] = DateTime.now().millisecondsSinceEpoch;
//   //     }
//   //   });
//   // }
...
//         conversationTopics[index] = topic;
//         replyCounts[index] = counts;
//         conversationTimestamps[index] = timestamp;
//       }
//     });
//   }
